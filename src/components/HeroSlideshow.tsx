...
export default function HeroSlideshow() {
  ...
  return (
    <div className="relative w-full overflow-hidden rounded-2xl select-none" style={{ height: "480px" }}>
      ...
      >
        <p className="text-white text-[10px] tracking-[0.25em] uppercase font-display font-medium px-2 py-0.5" style={{ backgroundColor: 'rgba(255,255,255,0.18)', lineHeight: '1', display: 'inline-block' }}>
