    ...
    <>
      ...
      <div style={{ opacity: showIntro ? 0 : 1, transition: "opacity 0.6s ease" }}>
        ...
        <section style={{ height:"100dvh", position:"relative", overflow:"hidden", background:"#0a0806" }}>
          ...
          {/* Film grain */}
          <svg style={{ position:"absolute",inset:0,width:"100%",height:"100%",zIndex:2,pointerEvents:"none",opacity:0.3 }} xmlns="http://www.w3.org/2000/svg">
            ...
            <rect width="100%" height="100%" filter="url(#g)" opacity="0.18"/>
          </svg>
